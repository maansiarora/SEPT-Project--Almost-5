...
class _View1State extends State<_View1> {
      ...
      onTap: () {
        ...
        final field = TextField(
          ...
          decoration: InputDecoration(
            ...
            labelText: "Medicine ${_controllers.length + 1}",
          ),
        );
  ...
  Widget _okButton() {
    return Container(
        height: 140,
        padding: const EdgeInsets.fromLTRB(40, 51, 40, 40),
        child: ElevatedButton(
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => const patientSave()),
            );
          },
  ...
  Widget _okButton(BuildContext context) {
    ...
    final button = ElevatedButton(
      onPressed: () async {
        ...
        String text = "Medicine: ${_nameControllers[index].text}\n" +
...
class _View4State extends State<_View4> {
  ...
  Widget _okButton(BuildContext context) {
    ...
    final button = ElevatedButton(
      onPressed: () async {
        final index = int.parse(_okController.text);
        String text = "Medicine: ${_groupControllers[index].name.text}\n" +
